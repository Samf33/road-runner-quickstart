...
@Autonomous
public class AlonAutoBlueWorkingGood extends LinearOpMode {
    MecanumDrive drive;
    ...
    final Pose2d SHOOT_POS = new Pose2d(-17, -17, Math.PI - 3 * Math.PI / 4);
    final Pose2d SHOOT_POS_LONG = new Pose2d(60, -20, Math.PI - Math.toRadians(150));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action getFirstRow = drive.actionBuilder(
                        new Pose2d(60, -20, Math.PI - Math.toRadians(180) - Math.PI / 6)
                )
                .strafeToLinearHeading(new Vector2d(28, -15), Math.PI - Math.PI / 2)
                .strafeTo(new Vector2d(28, 68))
                .build();
        Action getSecondRow = drive.actionBuilder(
                        new Pose2d(-17, -17, Math.PI - 3 * Math.PI / 4)
                )
                .setReversed(false)
                .strafeToLinearHeading(new Vector2d(6, -13), Math.PI - Math.PI / 2)
                .strafeTo(new Vector2d(6, 69))
                .build();
        Action getThirdRow = drive.actionBuilder(
                        new Pose2d(-17, -17, Math.PI - 3 * Math.PI / 4)
                )
                .strafeToLinearHeading(new Vector2d(-17, -13), Math.PI - Math.PI / 2)
        ...
        Action wait = drive.actionBuilder(new Pose2d(-13, -13, Math.PI - 3 * Math.PI / 4))
                .waitSeconds(1)
                .build();
        Action goToLaunch1 = drive.actionBuilder(
                        new Pose2d(new Vector2d(28, -69), Math.PI - Math.PI / 2)
                )
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(-17, -17, Math.PI - 3 * Math.PI / 4), new Rotation2d(Math.PI - -Math.PI / 4, Math.PI - -Math.PI / 4))
                .build();
        Action goToLaunch2 = drive.actionBuilder(
                        new Pose2d(new Vector2d(6, -69), Math.PI - Math.PI / 2)
                )
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(-17, -17, Math.PI - 3 * Math.PI / 4), new Rotation2d(Math.PI - -Math.PI / 4, Math.PI - -Math.PI / 4))
                .build();
        Action goToLaunch3 = drive.actionBuilder(
                        new Pose2d(new Vector2d(-17, -69), Math.PI - Math.PI / 2)
                )
                .setReversed(true)
//                .splineToLinearHeading(new Pose2d(-10, 10, 3*Math.PI/4), new Rotation2d(-Math.PI/4, -Math.PI/4))
                .strafeToLinearHeading(new Vector2d(-17, -17), Math.PI - 3 * Math.PI / 4)
                .build();
