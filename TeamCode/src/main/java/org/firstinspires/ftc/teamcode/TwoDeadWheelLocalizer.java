...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -41.03205246377082; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1978.791130656036; // x position of the perpendicular encoder (in tick units)
    }
