...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1986.5196682375547; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2491.993746056073; // x position of the perpendicular encoder (in tick units)
    }
